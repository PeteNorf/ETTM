...
public class WorldGenFernTree extends WorldGenAbstractTree{
	...
	public WorldGenFernTree(Block wood, Block leaves, int metaWood, boolean isFruitTree)
	{
	...
	public WorldGenFernTree(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow)
	{
		super(doBlockNotify);
